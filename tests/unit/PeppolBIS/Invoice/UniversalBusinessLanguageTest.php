...
namespace Tiime\UniversalBusinessLanguage\Tests\unit\PeppolBIS\Invoice;

use Tiime\EN16931\Codelist\CurrencyCodeISO4217 as CurrencyCode;
use Tiime\EN16931\DataType\Identifier\InvoiceIdentifier;
use Tiime\EN16931\DataType\Identifier\SpecificationIdentifier;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\AccountingCustomerParty;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\AccountingSupplierParty;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\AdditionalDocumentReference;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\Allowance;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\BillingReference;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\ContractDocumentReference;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\Delivery;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\DespatchDocumentReference;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\InvoiceLine;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\InvoicePeriod;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\LegalMonetaryTotal;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\OrderReference;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\OriginatorDocumentReference;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\PayeeParty;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\PaymentMeans;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\PaymentTerms;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\ProjectReference;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\ReceiptDocumentReference;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\TaxRepresentativeParty;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Aggregate\TaxTotal;
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\DataType\Basic\DueDate;
...
use Tiime\UniversalBusinessLanguage\PeppolBIS\Invoice\UniversalBusinessLanguage;
