...
class InvoicePeriodStartDateTest extends BaseXMLNodeTestWithHelpers
{
...
XML;
    ...
    public function testCanBeCreatedFromFullContent(): void
    {
        ...
        $ublObject = InvoicePeriodStartDate::fromXML($this->xpath, $currentElement);
        $this->assertInstanceOf(InvoicePeriodStartDate::class, $ublObject);
    ...
    public function testCannotBeCreatedFromInvalid(): void
    {
        ...
        InvoicePeriodStartDate::fromXML($this->xpath, $currentElement);
    }
