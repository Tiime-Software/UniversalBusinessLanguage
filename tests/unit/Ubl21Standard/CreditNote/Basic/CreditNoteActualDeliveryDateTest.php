...
use Tiime\UniversalBusinessLanguage\Ubl21Standard\CreditNote\DataType\Basic\ActualDeliveryDate;

class CreditNoteActualDeliveryDateTest extends BaseXMLNodeTestWithHelpers
{
...
XML;
    ...
    protected const XML_INVALID_WRONG_DATE = <<<XML
<CreditNote xmlns="urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2">
  <cbc:ActualDeliveryDate>201</cbc:ActualDeliveryDate>
</CreditNote>
XML;
...
XML;
    ...
    public function testCanBeCreatedFromFullContent(): void
    {
        ...
        $ublObject      = ActualDeliveryDate::fromXML($this->xpath, $currentElement);
        $this->assertInstanceOf(ActualDeliveryDate::class, $ublObject);
    ...
    public function testCannotBeCreatedFromInvalid(): void
    {
        ...
        $currentElement = $this->loadXMLDocument(self::XML_INVALID_WRONG_DATE);
